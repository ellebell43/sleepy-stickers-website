      ...
      <body className={`min-h-full w-full flex flex-col mx-auto antialiased transition-all ${fontAseprite.className}`}>
        ...
        <header className={`w-full px-5 flex justify-between items-center gap-12 md:gap-8 shadow-md pb-2 pt-3 z-10 border-b-4 relative gradient-bg`}>
          <nav id="navigation" className={`fixed top-0 ${showNav ? "right-0" : "-right-87.5"} transition-all duration-1000 border-l-4 bg-white dark:bg-gray-800 p-8 pr-32 text-4xl flex flex-col gap-8 h-screen z-50`} >
            ...
            {/* Home Link */}
            <Link href="/" className=" transition-all" onClick={() => setShowNav(false)}>
            ...
            {/* Shop Link */}
            <Link href="/shop" className=" transition-all" onClick={() => setShowNav(false)}>
              <div className="flex items-center">
            ...
            {/* Contact Link */}
            <Link href="/contact" className=" transition-all" onClick={() => setShowNav(false)}>
              <div className="flex items-center">
          ...
          <div className="flex justify-center items-center gap-6">
            <button className=" transition-all" onClick={() => setShowCart(!showCart)}>
              <div className="flex items-center">
          ...
          <div className={`fixed bg-gray-100 dark:bg-gray-700 border-l-4 top-0 ${showCart ? "right-0" : "-right-300"} h-screen p-4 transition-all duration-1000`}>
            {/* Close cart button */}
